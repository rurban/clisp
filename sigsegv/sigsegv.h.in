...
/* #define HAVE_STACK_OVERFLOW_RECOVERY ifdef HAVE_SIGALTSTACK in config.h */
#endif
 ...
 */
#if defined(__linux__) && (defined(i386) || defined(__i386) || defined(m68k) || defined(__m68k) || defined(mips) || defined(__mips) || defined(sparc) || defined(__sparc) || defined(alpha) || defined(__alpha) || defined(arm) || defined(__arm)) /* Linux */
