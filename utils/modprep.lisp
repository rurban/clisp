  ...
  (let ((object-tab-initdata
    ...
    (loop :for ch :across *checkers* :for default = (checker-default ch)
      ...
      :do (with-conditional (out (checker-cond-stack ch))
            ...
            (formatln out "    pushSTACK(O(~A));" type-tag)
            (formatln out "    pushSTACK(a); pushSTACK(TheSubr(subr_self)->name);")
            (formatln out "    check_value(type_error,GETTEXT(\"~~S: ~~S is not of type ~~S\"));")
            ...
            (cond ((stringp reverse)
                  ...
                  (t (formatln out "  pushSTACK(NIL);/*PLACE*/")
                     (formatln out "  pushSTACK(L_to_I(a));/*DATUM*/")
