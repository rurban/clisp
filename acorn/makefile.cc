...
i.charstrg : c.charstrg c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn c.uni_upcase c.uni_downcase c.uni_attribute
	$(CPP) $(CFLAGS) c.charstrg > i.charstrg

s.charstrg : c.charstrg c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn c.uni_upcase c.uni_downcase c.uni_attribute
	$(CC) $(CFLAGS) -S c.charstrg

o.charstrg : c.charstrg c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn c.uni_upcase c.uni_downcase c.uni_attribute
...
txt.UnicodeData :
	$(LN) ^.utils.unicode.ftp.unicode.org.txt.UnicodeData txt.UnicodeData

txt.clhs :
	$(LN) ^.src.txt.clhs txt.clhs
lisp : $(OBJECTS) o.modules      txt.UnicodeData txt.clhs
...
fas.clhs : lsp.clhs lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -B . -Efile ISO-8859-1 -norc -q -c clhs.lsp
...
stage.lsp.clhs : lsp.clhs
	$(LN) lsp.clhs stage

stage.lsp.german : lsp.german
	$(LN) lsp.german stage

stage.lsp.french : lsp.french
	$(LN) lsp.french stage
...
stage.fas.clhs : stage.lsp.clhs lisp mem.lispinit
	/@.lisp -M mem.lispinit -B . -Efile ISO-8859-1 -norc -q -c stage.clhs.lsp
...
html.impnotes : html._impnotes
	sed -e 's,href="CLHSROOT/,href="http://www.xanalys.com/software_tools/reference/HyperSpec/,' html._impnotes > html.impnotes
...
html.clisp : html._clisp c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn txt2c
	...
	$(CC) $(CFLAGS) $(CLFLAGS) c.text -o text
	/@.text > TMPPIPE1
	sed -e 's,HREF="CLHSROOT/,HREF="http://www.xanalys.com/software_tools/reference/HyperSpec/,' < TMPPIPE1 > html.clisp
	$(RM) TMPPIPE1
	$(RM) c.text
	$(RM) text
