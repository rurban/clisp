...
i.encoding : c.encoding c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn
	$(CPP) $(CFLAGS) c.encoding > i.encoding

s.encoding : c.encoding c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn
	$(CC) $(CFLAGS) -S c.encoding

o.encoding : c.encoding c.lispbibl c.fsubr c.subr c.pseudofun c.constsym c.constobj c.acorn
...
mem.interpre : lisp $(LSPFILES)
	-$(RM) mem.interpre
	/@.lisp -m 750KW -norc -x "(load \"init.lsp\") (sys::%saveinitmem) (exit)"
	$(MV) mem.lispimag mem.interpre

fas.init : lsp.init lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c init.lsp

fas.defseq : lsp.defseq lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defseq.lsp

fas.backquot : lsp.backquot lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c backquot.lsp

fas.defmacro : lsp.defmacro lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defmacro.lsp

fas.macros1 : lsp.macros1 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c macros1.lsp

fas.macros2 : lsp.macros2 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c macros2.lsp

fas.defs1 : lsp.defs1 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defs1.lsp

fas.timezone : lsp.timezone lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c timezone.lsp

fas.places : lsp.places lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c places.lsp

fas.floatpri : lsp.floatpri lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c floatpri.lsp

fas.type : lsp.type lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c type.lsp

fas.defstruc : lsp.defstruc lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defstruc.lsp

fas.format : lsp.format lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c format.lsp

fas.savemem : lsp.savemem lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c savemem.lsp

fas.trace : lsp.trace lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c trace.lsp

fas.compiler : lsp.compiler lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c compiler.lsp

fas.disassem : lsp.disassem lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c disassem.lsp

fas.defs2 : lsp.defs2 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defs2.lsp

fas.loop : lsp.loop lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c loop.lsp

fas.clos : lsp.clos lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c clos.lsp

fas.conditio : lsp.conditio lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c conditio.lsp

fas.gstream : lsp.gstream lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c gstream.lsp

fas.xcharin : lsp.xcharin lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c xcharin.lsp

fas.keyboard : lsp.keyboard lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c keyboard.lsp

fas.screen : lsp.screen lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c screen.lsp

fas.runprog : lsp.runprog lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c runprog.lsp

fas.query : lsp.query lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c query.lsp

fas.reploop : lsp.reploop lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c reploop.lsp

fas.dribble : lsp.dribble lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c dribble.lsp

fas.complete : lsp.complete lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c complete.lsp

fas.describe : lsp.describe lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c describe.lsp

fas.room : lsp.room lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c room.lsp

fas.edit : lsp.edit lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c edit.lsp

fas.macros3 : lsp.macros3 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c macros3.lsp

fas.foreign1 : lsp.foreign1 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c foreign1.lsp

fas.defs3 : lsp.defs3 lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c defs3.lsp

fas.spanish : lsp.spanish lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c spanish.lsp

fas.config : lsp.config lisp mem.interpre
	/@.lisp -m 1000KW -M mem.interpre -norc -q -c config.lsp
...
mem.lispinit : lisp $(FASFILES)
	-$(RM) mem.lispinit
	/@.lisp -norc -x "(load \"init.fas\") (sys::%saveinitmem) (exit)"
...
stage.lsp.savemem : lsp.savemem
	$(LN) lsp.savemem stage
...
stage.lsp.xcharin : lsp.xcharin
	$(LN) lsp.xcharin stage

stage.lsp.keyboard : lsp.keyboard
	$(LN) lsp.keyboard stage

stage.lsp.screen : lsp.screen
	$(LN) lsp.screen stage

stage.lsp.runprog : lsp.runprog
	$(LN) lsp.runprog stage

stage.lsp.query : lsp.query
	$(LN) lsp.query stage

stage.lsp.reploop : lsp.reploop
	$(LN) lsp.reploop stage

stage.lsp.dribble : lsp.dribble
	$(LN) lsp.dribble stage

stage.lsp.complete : lsp.complete
	$(LN) lsp.complete stage

stage.lsp.describe : lsp.describe
	$(LN) lsp.describe stage

stage.lsp.room : lsp.room
	$(LN) lsp.room stage

stage.lsp.edit : lsp.edit
	$(LN) lsp.edit stage
...
impnotes.html: html._impnotes
	sed -e 's,<HS>,http://www.harlequin.com/education/books/HyperSpec,' html._impnotes > html.impnotes
...
clean1 : clean0
	...
	-rmdir wstage
	-rmdir wsuite
	-$(RM) README README_de README_en README_es 1.clisp man.clisp html.clisp html.impnotes c.clisp distmakefile $(TXTFILES) clreadline.3 man.clreadline html.clreadline dvi.clreadline dvi.readline
