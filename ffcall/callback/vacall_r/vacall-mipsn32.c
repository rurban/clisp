  ...
  switch (list.rtype)
    {
      ...
      case __VAlonglong:  iret = list.tmp._longlong; break;
      case __VAulonglong: iret = list.tmp._ulonglong; break;
                    ...
                    switch (list.rsize)
                      {
                        ...
                        case sizeof(long long): iret = *(unsigned long long *) list.raddr; break;
                        default:                break;
                      }
                else
