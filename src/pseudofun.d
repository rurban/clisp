...
PSEUDOFUN(rd_by_iau_handle) PSEUDOFUN(rd_by_ias_handle) PSEUDOFUN(rd_by_iau8_handle) PSEUDOFUN(rd_by_array_iau8_handle)
PSEUDOFUN(wr_by_iau_handle) PSEUDOFUN(wr_by_ias_handle) PSEUDOFUN(wr_by_iau8_handle) PSEUDOFUN(wr_by_array_iau8_handle)
PSEUDOFUN(rd_ch_handle) PSEUDOFUN(rd_ch_array_handle) PSEUDOFUN(wr_ch_handle_x) PSEUDOFUN(wr_ch_array_handle_x) PSEUDOFUN(wr_ss_handle_x)
...
PSEUDOFUN(rd_by_iau_file) PSEUDOFUN(rd_by_ias_file) PSEUDOFUN(rd_by_ibu_file) PSEUDOFUN(rd_by_ibs_file) PSEUDOFUN(rd_by_icu_file) PSEUDOFUN(rd_by_ics_file) PSEUDOFUN(rd_by_iau8_file)
PSEUDOFUN(read_byte_array_iau8_file)
PSEUDOFUN(wr_by_iau_file) PSEUDOFUN(wr_by_ias_file) PSEUDOFUN(wr_by_ibu_file) PSEUDOFUN(wr_by_ibs_file) PSEUDOFUN(wr_by_icu_file) PSEUDOFUN(wr_by_ics_file) PSEUDOFUN(wr_by_iau8_file)
PSEUDOFUN(write_byte_array_iau8_file)
