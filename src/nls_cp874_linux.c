 ...
 * nls_cp874-linux.c
 *
 * Charset cp874-linux translation tables.
 * Generated automatically by the nls_table utility.
 */

#define charset2uni cp874_linux_charset2uni
...
static const struct nls_unicode charset2uni[256] = {
  ...
  /* 0x80 */
  0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0x2026, 0xfffd, 0xfffd,
...
#define uni2charset cp874_linux_uni2charset
#define page00 cp874_linux_page00
#define page0e cp874_linux_page0e
#define page20 cp874_linux_page20
...
struct nls_table nls_cp874_linux_table = {
  "cp874-linux",
  uni2charset,
  charset2uni
};
