/* vi_mode.c -- changed by Bruno Haible, 7 January 1995 */
...
extern void _rl_dispatch _PROTO((int key, Keymap map));

extern void rl_extend_line_buffer _PROTO((int len));

/* Forward declarations */
void _rl_vi_reset_last _PROTO((void));
void _rl_vi_set_last _PROTO((int key, int repeat, int sign));
int rl_vi_textmod_command _PROTO((int c));
int rl_vi_redo _PROTO((int count, int c));
int rl_vi_yank_arg _PROTO((int count, int key));
int rl_vi_fetch_history _PROTO((int count, int c));
int rl_vi_search_again _PROTO((int count, int key));
int rl_vi_search _PROTO((int count, int key));
int rl_vi_complete _PROTO((int ignore, int key));
int rl_vi_tilde_expand _PROTO((int ignore, int key));
int rl_vi_prev_word _PROTO((int count, int key));
int rl_vi_next_word _PROTO((int count, int key));
int rl_vi_end_word _PROTO((int count, int key));
int rl_vi_fWord _PROTO((int count));
int rl_vi_bWord _PROTO((int count));
int rl_vi_eWord _PROTO((int count));
int rl_vi_fword _PROTO((int count));
int rl_vi_bword _PROTO((int count));
int rl_vi_eword _PROTO((int count));
int rl_vi_insert_beg _PROTO((int count, int key));
int rl_vi_append_mode _PROTO((void));
int rl_vi_append_eol _PROTO((int count, int key));
int rl_vi_eof_maybe _PROTO((int count, int c));
int rl_vi_insertion_mode _PROTO((void));
void _rl_vi_done_inserting _PROTO((void));
int rl_vi_movement_mode _PROTO((int count, int key));
int rl_vi_arg_digit _PROTO((int count, int c));
int rl_vi_change_case _PROTO((int count, int ignore));
int rl_vi_put _PROTO((int count, int key));
int rl_vi_check _PROTO((void));
int rl_vi_column _PROTO((int count, int key));
int rl_vi_domove _PROTO((int key, int *nextkey));
static int rl_digit_loop1 _PROTO((void));
int rl_vi_delete_to _PROTO((int count, int key));
int rl_vi_change_to _PROTO((int count, int key));
int rl_vi_yank_to _PROTO((int count, int key));
int rl_vi_delete _PROTO((int count, int key));
int rl_vi_comment _PROTO((int count, int key));
int rl_vi_first_print _PROTO((int count, int key));
int rl_back_to_indent _PROTO((void));
int rl_vi_char_search _PROTO((int count, int key));
int rl_vi_match _PROTO((int ignore, int key));
int rl_vi_bracktype _PROTO((int c));
int rl_vi_change_char _PROTO((int count, int key));
int rl_vi_subst _PROTO((int count, int key));
int rl_vi_overstrike _PROTO((int count, int key));
int rl_vi_overstrike_delete _PROTO((int count));
int rl_vi_replace _PROTO((int count, int key));
