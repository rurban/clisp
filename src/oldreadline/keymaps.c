...
/* Section "Functions for manipulating Keymaps." */
Keymap rl_make_bare_keymap _PROTO((void));
Keymap rl_copy_keymap _PROTO((Keymap map));
Keymap rl_make_keymap _PROTO((void));
void rl_discard_keymap _PROTO((Keymap map));
