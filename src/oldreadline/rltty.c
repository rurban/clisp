...
static void block_sigint _PROTO((void));
static void release_sigint _PROTO((void));
static int outchar _PROTO((int c));
static void control_meta_key _PROTO((int on));
void rl_prep_terminal _PROTO((int meta_flag));
void rl_deprep_terminal _PROTO((void));
int rl_restart_output _PROTO((void));
int rl_stop_output _PROTO((int count, int key));
void rltty_set_default_bindings _PROTO((Keymap kmap));
