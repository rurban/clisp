...
int rl_reverse_search_history _PROTO((int sign, int key));
int rl_forward_search_history _PROTO((int sign, int key));
static void rl_display_search _PROTO((char *search_string, int reverse_p, int where));
