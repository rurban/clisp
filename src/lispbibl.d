...
# this machine: OS2 or WIN32 or GENERIC_UNIX
...
# Determine properties of compiler and environment:
  ...
  #endif
  #if defined(OS2) || (defined(WIN32) && defined(I80386))
...
# How time is measured:
  ...
  #define TIME_WIN32
#endif
#if defined(TIME_MSDOS) || defined(TIME_UNIX_TIMES)
...
# g++ 3.3 doesn't accept compound expressions as initializers.)
#if !(defined(WIDE_SOFT) && !defined(WIDE_STRUCT)) && !(defined(EMUNIX) || (defined(__GNUG__) && (__GNUC__ == 3) && (__GNUC_MINOR__ == 3) && defined(DEBUG_GCSAFETY)))
...
#if (defined(UNIX) && !defined(UNIX_MINT)) || defined(EMUNIX) || defined(WIN32)
