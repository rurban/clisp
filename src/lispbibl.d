...
# this machine: AMIGA or OS2 or WIN32 or GENERIC_UNIX
  ...
  #define WIN32
#endif
#if !(defined(AMIGA) || defined(OS2) || defined(WIN32))
  #if defined(unix)
    #define GENERIC_UNIX
  #else
...
# Determine properties of compiler and environment:
...
#elif defined(AMIGA) || defined(OS2) || defined(WIN32)
  ...
  #endif
  #if defined(AMIGA) || defined(OS2) || (defined(WIN32) && defined(I80386))
...
#if defined(MSDOS) || ((defined(UNIX) && !defined(NEXTAPP) || defined(MAYBE_NEXTAPP)) && !defined(NO_TERMCAP_NCURSES)) || defined(WIN32_NATIVE)
  #define KEYBOARD
  #if 0
...
# with Strings
#if defined(UNIX) || defined(MSDOS) || defined(AMIGAOS) || defined(WIN32)
  #define HAVE_ENVIRONMENT
#endif
# When changed: do nothing

# Whether the operating system has a preferred command-interpreter:
#if defined(UNIX) || defined(MSDOS) || defined(AMIGAOS) || defined(WIN32_NATIVE)
  #define HAVE_SHELL
#endif
# When changed: extend pathname.d
...
# How time is measured:
  ...
  #define TIME_WIN32
#endif
#if defined(TIME_MSDOS) || defined(TIME_AMIGAOS) || defined(TIME_UNIX_TIMES)
...
#if defined(TIME_MSDOS) || defined(TIME_AMIGAOS)
  #define SLEEP_1
#endif
...
# systems: AMIGAOS can't give that information):
#if defined(UNIX) || defined(WIN32_NATIVE)
...
#endif
#if defined(UNIX) || defined(EMUNIX) || defined(WIN32) || defined(HYPERSTONE)
...
#if (defined(UNIX) && !defined(UNIX_MINT)) || defined(EMUNIX) || defined(WIN32) # || defined(AMIGAOS) # ?JCH??
