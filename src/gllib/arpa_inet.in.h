...
_gl_GL_FUNCDECL_SYS (inet_ntop, const char *,
...
/* Need to cast, because on NonStop Kernel, the fourth parameter is
                                            size_t cnt.  */
_gl_GL_CXXALIAS_SYS_CAST (inet_ntop, const char *,
                       (int af, const void *restrict src,
                        char *restrict dst, socklen_t cnt));
_gl_GL_CXXALIASWARN (inet_ntop);
#elif defined GNULIB_POSIXCHECK
# undef inet_ntop
# if HAVE_RAW_DECL_INET_NTOP
_gl_GL_WARN_ON_USE (inet_ntop, "inet_ntop is unportable - "
...
_gl_GL_FUNCDECL_SYS (inet_pton, int,
                  (int af, const char *restrict src, void *restrict dst)
                  _gl_GL_ARG_NONNULL ((2, 3)));
# endif
_gl_GL_CXXALIAS_SYS (inet_pton, int,
                  (int af, const char *restrict src, void *restrict dst));
_gl_GL_CXXALIASWARN (inet_pton);
#elif defined GNULIB_POSIXCHECK
# undef inet_pton
# if HAVE_RAW_DECL_INET_PTON
_gl_GL_WARN_ON_USE (inet_pton, "inet_pton is unportable - "
                 "use gnulib module inet_pton for portability");
# endif
#endif


#endif /* _gl_GL_ARPA_INET_H */
#endif /* _gl_GL_ARPA_INET_H */
