...
(def-c-call-out gamma_r (:arguments (x double-float) (iptr (c-ptr double-float) :out))
                        (:return-type double-float)
)
(def-c-call-out lgamma_r (:arguments (x double-float) (iptr (c-ptr double-float) :out))
                         (:return-type double-float)
)
...
(def-c-call-out gammaf_r (:arguments (x single-float) (iptr (c-ptr single-float) :out))
                         (:return-type single-float)
)
(def-c-call-out lgammaf_r (:arguments (x single-float) (iptr (c-ptr single-float) :out))
                          (:return-type single-float)
)
