...
_sc_gl_GL_WARN_ON_USE (strcasecmp, "strcasecmp cannot work correctly on character "
...
_sc_gl_GL_WARN_ON_USE (strncasecmp, "strncasecmp cannot work correctly on character "
                 "strings in multibyte locales - "
