...
extern int rpl_connect (int, struct sockaddr *, int) _sc_gl_GL_ARG_NONNULL ((2));
#  endif
# elif @HAVE_WINSOCK2_H@
#  undef connect
...
extern int rpl_bind (int, struct sockaddr *, int) _sc_gl_GL_ARG_NONNULL ((2));
#  endif
# elif @HAVE_WINSOCK2_H@
#  undef bind
...
extern int rpl_recv (int, void *, int, int) _sc_gl_GL_ARG_NONNULL ((2));
#  endif
# elif @HAVE_WINSOCK2_H@
#  undef recv
...
extern int rpl_send (int, const void *, int, int) _sc_gl_GL_ARG_NONNULL ((2));
#  endif
# elif @HAVE_WINSOCK2_H@
#  undef send
