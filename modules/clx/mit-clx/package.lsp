...
(export
  '(
    *version* access-control access-error access-hosts
    ...
    translation-function #-cmu type-error undefine-keysym unexpected-reply
    ...
    untrace-display show-trace display-trace ; for backwards compatibility
    describe-request describe-event describe-reply describe-error
    describe-trace
    ))
