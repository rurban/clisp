...
#-(or XCL CLISP GCL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
...
(aref a 2 2)
#+(or XCL CMU SBCL OpenMCL) 0 #+(or CLISP AKCL ALLEGRO) NIL #-(or XCL CLISP AKCL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
