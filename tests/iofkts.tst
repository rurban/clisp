...
(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123  " :JUNK-ALLOWED T))
(123 #+XCL 7 #+(or CLISP AKCL ALLEGRO) 5 #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "123 t" :JUNK-ALLOWED T))
(123 #+XCL 4 #+(or CLISP AKCL ALLEGRO) 3 #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123   t  " :JUNK-ALLOWED T))
(123 #+XCL 8 #+(or CLISP AKCL ALLEGRO) 5 #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN)
...
(1 #+XCL 2 #+(or CLISP AKCL ALLEGRO) 1 #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN)
...
#+(or CLISP ALLEGRO) CHARACTER #-(or CLISP ALLEGRO) STRING-CHAR
...
20) (READ S))
#+XCL CRACKERS #+(or CLISP AKCL ALLEGRO) ERROR #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN

J
#+XCL 20 #+(or CLISP AKCL ALLEGRO) 7 #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN
