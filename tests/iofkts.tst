...
(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123  " :JUNK-ALLOWED T))
(123 #+XCL 7 #+(or CLISP AKCL ALLEGRO CMU) 5 #-(or XCL CLISP AKCL ALLEGRO CMU) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "123 t" :JUNK-ALLOWED T))
(123 #+XCL 4 #+(or CLISP AKCL ALLEGRO CMU) 3 #-(or XCL CLISP AKCL ALLEGRO CMU) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123   t  " :JUNK-ALLOWED T))
(123 #+XCL 8 #+(or CLISP AKCL ALLEGRO CMU) 5 #-(or XCL CLISP AKCL ALLEGRO CMU) UNKNOWN)
...
(1 #+XCL 2 #+(or CLISP AKCL ALLEGRO CMU) 1 #-(or XCL CLISP AKCL ALLEGRO CMU) UNKNOWN)
