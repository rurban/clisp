...
(LIST-LENGTH '(A . B))
#+XCL 1 #+(or CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) ERROR
...
(COPY-ALIST '(A B))
#+(or XCL CLISP ECL ALLEGRO CMU SBCL) (A B) #+(or GCL OpenMCL) ERROR
#-(or XCL CLISP ECL GCL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
...
(COPY-ALIST '((A B)
              C
              (D E)))
#+(or XCL CLISP ECL ALLEGRO CMU SBCL) ((A B) C (D E)) #+(or GCL OpenMCL) ERROR
#-(or XCL CLISP ECL GCL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
...
(NCONC '(1 2) 'A)
#+XCL ERROR #+(or CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) (1 2 . A)
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) UNKNOWN

(NCONC 'A)
#+XCL ERROR #+(or CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) A
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
...
#+CLISP (C B A D E F)
#+(or AKCL ECL ALLEGRO CMU SBCL OpenMCL) (A D E F)
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
...
#+XCL WAS-DESTROYED
#+CLISP (C B A)
#+(or AKCL ECL ALLEGRO CMU SBCL OpenMCL) (A)
...
(NCONC NIL 'X)
#+XCL ERROR
#+(or CLISP AKCL ECL ALLEGRO CMU SBCL OpenMCL) X
#-(or XCL CLISP AKCL ALLEGRO CMU SBCL OpenMCL) UNKNOWN
