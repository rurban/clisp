...
(LIST-LENGTH '(A . B))
#+XCL 1 #+(or CLISP AKCL ECL ALLEGRO CMU SBCL) ERROR
...
(COPY-ALIST '(A B))
#+(or XCL CLISP ECL ALLEGRO CMU SBCL) (A B) #+GCL ERROR
#-(or XCL CLISP ECL GCL ALLEGRO CMU SBCL) UNKNOWN
...
(COPY-ALIST '((A B)
              C
              (D E)))
#+(or XCL CLISP ECL ALLEGRO CMU SBCL) ((A B) C (D E)) #+GCL ERROR
#-(or XCL CLISP ECL GCL ALLEGRO CMU SBCL) UNKNOWN
...
(NCONC '(1 2) 'A)
#+XCL ERROR #+(or CLISP AKCL ECL ALLEGRO CMU SBCL) (1 2 . A)
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL) UNKNOWN

(NCONC 'A)
#+XCL ERROR #+(or CLISP AKCL ECL ALLEGRO CMU SBCL) A
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL) UNKNOWN
...
#+CLISP (C B A D E F)
#+(or AKCL ECL ALLEGRO CMU SBCL) (A D E F)
#-(or XCL CLISP AKCL ECL ALLEGRO CMU SBCL) UNKNOWN
...
#+XCL WAS-DESTROYED
#+CLISP (C B A)
#+(or AKCL ECL ALLEGRO CMU SBCL) (A)
...
(NCONC NIL 'X)
#+XCL ERROR
#+(or CLISP AKCL ECL ALLEGRO CMU SBCL) X
#-(or XCL CLISP AKCL ALLEGRO CMU SBCL) UNKNOWN
