...
#+ALLEGRO (&OPTIONAL &REST &KEY &AUX &BODY &WHOLE &ALLOW-OTHER-KEYS &ENVIRONMENT)
...
#+XCL ERROR #+(or CLISP AKCL ALLEGRO) T #-(or XCL CLISP AKCL ALLEGRO) UNKNOWN
...
(LOG 3 0)
#+XCL 0 #+ALLEGRO 0.0 #-(or XCL ALLEGRO) ERROR
...
#+ALLEGRO "1.6331778728383844d+16"
#-(or XCL CLISP AKCL ALLEGRO) UNKNOWN
...
#-(or XCL CLISP ALLEGRO) #C(0.0 0.0044721322)

(ATAN 1)
#+(or XCL ALLEGRO) 0.7853982 #+CLISP 0.7853981 #-(or XCL ALLEGRO CLISP) UNKNOWN

(prin1-to-string PI )
#+XCL "3.141592653589793D0"
#+CLISP "3.1415926535897932385L0"
#+ALLEGRO "3.141592653589793d0"
#-(or XCL CLISP ALLEGRO) UNKNOWN
...
#-ALLEGRO "0.48121184" #+ALLEGRO "0.4812118" ; "0.4812118"

(prin1-to-string (ASINH 3/7) )
#-(or CLISP ALLEGRO) "0.4164308"
...
#-(or CLISP ALLEGRO) "0.4" ; #+XCL "0.3999996"
#+(or CLISP ALLEGRO) "0.39999962" ; Rundungsfehler
...
BOOLE-SET
#+(or XCL ALLEGRO) 1 #+CLISP 15 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-1
#+(or XCL ALLEGRO) 2 #+CLISP 10 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-2
#+(or XCL ALLEGRO) 3 #+CLISP 12 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-C1
#+(or XCL ALLEGRO) 4 #+CLISP 5 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-C2
#+(or XCL ALLEGRO) 5 #+CLISP 3 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-AND
#+(or XCL ALLEGRO) 6 #+CLISP 8 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-IOR
#+(or XCL ALLEGRO) 7 #+CLISP 14 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-XOR
#+(or XCL ALLEGRO) 8 #+CLISP 6 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-EQV
#+(or XCL ALLEGRO) 9 #+CLISP 9 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-NAND
#+(or XCL ALLEGRO) 10 #+CLISP 7 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-NOR
#+(or XCL ALLEGRO) 11 #+CLISP 1 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-ANDC1
#+(or XCL ALLEGRO) 12 #+CLISP 4 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-ANDC2
#+(or XCL ALLEGRO) 13 #+CLISP 2 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-ORC1
#+(or XCL ALLEGRO) 14 #+CLISP 13 #-(or XCL CLISP ALLEGRO) UNKNOWN

BOOLE-ORC2
#+(or XCL ALLEGRO) 15 #+CLISP 11 #-(or XCL CLISP ALLEGRO) UNKNOWN
...
EQL))
#-ALLEGRO (A B C D) #+ALLEGRO (D C B A)

(NSET-DIFFERENCE (QUOTE (A B C D)) (QUOTE (I J C)))
#-ALLEGRO (A B D) #+ALLEGRO (D B A)
