...
CHAR-CODE-LIMIT
#+XCL 128 #+(or (and CLISP (not UNICODE)) AKCL ECL CMU) 256 #+(or (and CLISP UNICODE) ALLEGRO) 65536 #-(or XCL CLISP AKCL ECL ALLEGRO CMU) UNKNOWN
...
(#-CMU STRING-CHAR-P #+CMU CHARACTERP #\$)
T
...
(#-CMU STRING-CHAR-P #+CMU CHARACTERP #\5)
T
...
(#-CMU STRING-CHAR-P #+CMU CHARACTERP #\BACKSPACE)
T

(#-CMU STRING-CHAR-P #+CMU CHARACTERP #\PAGE)
T

(#-CMU STRING-CHAR-P #+CMU CHARACTERP #\RETURN)
T
